...
# ------------------------------------------------------------
#  [YENİ] UYGULAMA İLE TAM UYUMLU DİNAMİK TÜRLENDİRME SİSTEMİ
# ------------------------------------------------------------
def basliktan_tur_bul(title):
    ...
    genre_map = {
        ...
        "Science Fiction": [
            "space", "alien", "robot", "future",
            "galaxy", "planet", "star", "mars",
            "cyber", "time travel", "dune"
        ],
...
# Yeni 'genre' (tür) kolonunu tam uyumlu olarak atıyoruz
...
# Tür dağılımını terminale yazdırıp kontrol edelim
print("\n📝 Kitap Türü Dağılımları:")
